...
public class FavoriteController(IFavoriteService favoriteService) : ControllerBase
{
    ...
    {
        var result = await favoriteService.AddFavoriteAsync(userId, bookId);
    ...
    {
        var result = await favoriteService.RemoveFavoriteAsync(userId, bookId);
    ...
    {
        var isFavorite = await favoriteService.IsFavoriteAsync(userId, bookId);
